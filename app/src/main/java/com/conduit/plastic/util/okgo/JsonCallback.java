package com.conduit.plastic.util.okgo;
...
//                .params("sk", UserUtils.getInstance().getSk())
//        request.params("fileType", "10")//
//                .params("docType", "30")//
//                .params("sk", UserUtils.getInstance().getSk());
    }
    ...
    public T convertSuccess(Response response) throws Exception {
       ...
       if (rawType == BaseEntity.class) {
            //有数据类型，表示有data
           BaseEntity lzyResponse = Convert.fromJson(jsonReader, type);
            response.close();
            ...
            if (code == 0) {
                ...
                throw new IllegalStateException("错误代码：" + code + "，错误信息：" + lzyResponse.error);
            }
        } else {
            response.close();
