...
import com.conduit.plastic.view.banner.listener.OnBannerClickListener;
import com.conduit.plastic.view.banner.listener.OnBannerListener;
import com.conduit.plastic.view.banner.loader.ImageLoaderInterface;
import com.conduit.plastic.view.banner.view.BannerViewPager;
...
public class BannerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.dot_gray;
    private int mIndicatorUnselectedResId = R.drawable.dot_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.BannerView_indicator_drawable_selected, R.drawable.dot_white);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.BannerView_indicator_drawable_unselected, R.drawable.dot_gray);
     ...
     * transformations to each page, overriding the default_img sliding look and feel.
     *
