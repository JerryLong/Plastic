...
package com.conduit.plastic.view.banner.transformer;
...
public abstract class ABaseTransformer implements ViewPager.PageTransformer {
	...
	/**
	 * Indicates if the default_img animations of the view pager should be used.
	 *
	 * @return
	 */
	 ...
	 * <p>
	 * The default_img implementation attempts to reset all view properties. This is useful when toggling transforms that do
