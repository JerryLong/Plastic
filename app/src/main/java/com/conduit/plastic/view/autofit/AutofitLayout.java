    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    me.grantland.widget.R.styleable.AutofitTextView,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(me.grantland.widget.R.styleable.AutofitTextView_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(me.grantland.widget.R.styleable.AutofitTextView_minTextSize,
                    minTextSize);
            precision = ta.getFloat(me.grantland.widget.R.styleable.AutofitTextView_precision, precision);
            ta.recycle();
        }
