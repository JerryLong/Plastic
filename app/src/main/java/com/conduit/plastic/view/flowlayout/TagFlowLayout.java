package com.conduit.plastic.view.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabMax = ta.getInt(R.styleable.TagFlowLayout_max_tab, -1);
        ta.recycle();
...
//            lp.rightMargin = clp.rightMargin;
            ...
            if (tagView.getLayoutParams() != null) {
                ...
                if (mTabMax != -1) {
                    lp = new MarginLayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
                } else {
                    lp = new MarginLayoutParams((ScreenUtils.getScreenWidth(getContext())-10) / mTabMax, LayoutParams.MATCH_PARENT);
                }
