...
public class MainFragment extends BaseFrameFragment<MainPresenter, MainModel> implements MainContract.View {
...
//                    lp.width = (ScreenUtils.getScreenWidth(getActivity())-16)/4;
        ...
        specTag.setAdapter(new TagAdapter<String>(texture) {
            ...
            public View getView(FlowLayout parent, int position, String s) {
                ...
                if (!TextUtils.isEmpty(s)) {
                    textView = (TextView) mInflater.inflate(R.layout.tag_layout, parent, false);
//                    ViewGroup.LayoutParams lp = textView.getLayoutParams();
//                    lp.width = (ScreenUtils.getScreenWidth(getActivity())-40)/4;
//                    textView.setLayoutParams(lp);
                    textView.setText(s);
                }
                return textView;
    ...
    @OnClick({R.id.brand_btn, R.id.main_quality_fold, R.id.main_spec_two, R.id.main_spec_fold, R.id.main_search, R.id.product_btn, R.id.area_btn, R.id.main_quality_two})
...
//                BrandActivity.navToBrand(getActivity(), true);
            ...
            case R.id.main_quality_fold:
                if (qualityTag.getVisibility()==View.VISIBLE){
                    qualityTag.setVisibility(View.GONE);
                }else {
                    qualityTag.setVisibility(View.VISIBLE);
                }
                break;
            case R.id.main_spec_two:
                break;
            case R.id.main_spec_fold:
                if (specTag.getVisibility()==View.VISIBLE){
                    specTag.setVisibility(View.GONE);
                }else {
                    specTag.setVisibility(View.VISIBLE);
                }
                break;
        }
    }
