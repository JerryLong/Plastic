package com.plastic.xrecyclerview.decoration;
...
public class GridAllEntrust extends SpacesItemDecorationEntrust {


    public GridAllEntrust(int leftRight, int topBottom, int mColor) {
...
//                        right =leftRight;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (layoutManager.getOrientation() == GridLayoutManager.VERTICAL) {//竖直方向的
            ...
            if ((childPosition) % layoutManager.getSpanCount() == 0) {//被整除的需要右边
